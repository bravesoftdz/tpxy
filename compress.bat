...
cd Win32\Release
"%PROGRAMFILES%\7-Zip\7z.exe" a -tzip -mx ..\..\tpxy-win32.zip *.exe *.bat *svc.ini README.md LICENSE
cd ..\..

if exist tpxy-win64.zip del tpxy-win64.zip
cd Win64\Release
"%PROGRAMFILES%\7-Zip\7z.exe" a -tzip -mx ..\..\tpxy-win64.zip *.exe *.bat *svc.ini README.md LICENSE
cd ..\..
